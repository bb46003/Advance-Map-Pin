...
<img width="446" height="405" alt="image" src="https://github.com/user-attachments/assets/5d7e39ef-03d3-4c71-add2-8124d301cfd6" />
These settings are specific to each Map Note and override the global module settings.

When you add either an image, text, or both in the Note configuration, hovering over the Map Note will display a custom overlay element.
<img width="441" height="334" alt="image" src="https://github.com/user-attachments/assets/d7a6e6c4-e948-49e8-b8d2-5d6ddec5de59" />
